...
monitor.on('up', (res) => logger(`${res.address}:${res.port} IS  ONLINE!!`, "[ UPTIME BY 𝐀𝐒𝐈𝐅 𝐱𝟔𝟗]"));
monitor.on('down', (res) => console.log(`${res.address} ${res.statusMessage}`));
monitor.on('stop', (website) => console.log(`${website}`) );
monitor.on('error', (error) => console.log(error));
monitor.on('up', (res) => logger(`Credit: 𝐀𝐒𝐈𝐅 𝐱𝟔𝟗`, "[ File Owner ]"));
monitor.on('up', (res) => logger(`I hope you have a good day today idol btw thanks for using my file bot idol`, "[ 𝐀𝐒𝐈𝐅 𝐱𝟔𝟗 ]"));
/////////////////////////////////////////////
